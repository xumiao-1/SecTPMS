...
PROGMEM static const RF22::ModemConfig MODEM_CONFIG_TABLE[] =
{
    ...
    // add by Miao, for TPMS
    { 0x1d, 0x03, 0x98, 0x20, 0x50, 0x48, 0x00, 0x13, 0x40, 0x0a, 0x1e, 0x80, 0x60, 0x28, 0x24, 0x2c, 0x22, 0x48 }, // 4.9, 45
    { 0x1e, 0x03, 0xcc, 0x00, 0xa0, 0x90, 0x00, 0x48, 0x40, 0x0a, 0x1e, 0x80, 0x60, 0x50, 0x48, 0x2c, 0x22, 0x48 }, // 9.8, 45
};
...
boolean RF22::init()
{
    ...
    spiWrite(RF22_REG_33_HEADER_CONTROL2, RF22_HDLEN_0 | RF22_SYNCLEN_1);
    setPreambleLength(8);
    uint8_t syncwords[] = { 0x01 };
    ...
    setFrequency(314.975, 0.05);
//    setFrequency(900.0);
    // Some slow, reliable default speed and modulation
    setModemConfig(FSK_Rb9_8Fd45);
