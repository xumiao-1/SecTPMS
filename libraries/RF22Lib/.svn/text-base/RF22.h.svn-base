...
/// from http://www.airspayce.com/mikem/arduino/RF22/RF22-1.30.zip
...
/// For best result, use level shifter, or use a RF22 shiled or board with level shifters built in, 
...
/// the Sparkfun RFM22 shield to a Mega, since the SPI pins on the Mega a different to other Arduinos, 
...
///  \version 1.29 Improvements to waitAvailableTimeout to make it robust on millis() rollover. Contributed by ///                Mats Byggmastar.
...
public:
	...
	// add by Miao
	FSK_Rb4_9Fd45,       ///< FSK, No Manchester, Rb = 4.9kbs,  Fd = 45kHz
	FSK_Rb9_8Fd45       ///< FSK, No Manchester, Rb = 9.8kbs,  Fd = 45kHz
    } ModemConfigChoice;
